...
We can see here that one migration has started, and one has not yet started.
...
Ok, so we don't have to sit here and watch 60GB traveling through the ne, let us continue with an environment that we already migrated.
