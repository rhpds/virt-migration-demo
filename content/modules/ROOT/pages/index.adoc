...
This limits limit the steps you need to take to completethe demonstration and fumbling around with copy-paste.
...
. Navigate to the https://{openshift_console}[OpenShift Console^]
+
...
Or you can click *Migration* -> *Providers* for virtualization
...
For that, the we create a "route", you can think of that like a DNS name or a loadbalancer...
