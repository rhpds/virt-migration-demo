...
. Click *Next*.
+
image::module-05/NN_Create_Migration_Plan_2.png[link=self, window=blank, width=100%]
...
+
image::module-05/NN_Create_Migration_Plan_3.png[link=self, window=blank, width=100%]
...
+
image::module-05/NN_Await_Migration_Plan_Ready.png[link=self, window=blank, width=100%]
+
...
+
image::module-05/NN_Start_Migration_Modal.png[link=self, window=blank, width=100%]
+
. A progress bar will appear in the center of the screen along with the status of *0 of 1 VMs migrated*.
+
image::module-05/NN_Migration_Plan_Running.png[link=self, window=blank, width=100%]
